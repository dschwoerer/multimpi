...
_Static_assert(sizeof(void *) >= sizeof(MPI_Comm),
               "Naive mapping for MPI_Comm not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_Datatype),
               "Naive mapping for MPI_Datatype not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_Op),
...
_Static_assert(sizeof(void *) >= sizeof(MPI_File),
               "Naive mapping for MPI_File not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_Win),
               "Naive mapping for MPI_Win not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_Aint),
               "Naive mapping for MPI_Aint not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_Offset),
               "Naive mapping for MPI_Offset not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_Info),
               "Naive mapping for MPI_Info not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_Errhandler),
               "Naive mapping for MPI_Errhandler not working!");
_Static_assert(sizeof(void *) >= sizeof(MPIO_Request),
               "Naive mapping for MPIO_Request not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_Message),
               "Naive mapping for MPI_Message not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_Delete_function),
               "Naive mapping for MPI_Delete_function not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_User_function),
               "Naive mapping for MPI_User_function not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_Comm_copy_attr_function),
               "Naive mapping for MPI_Comm_copy_attr_function not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_Comm_delete_attr_function),
               "Naive mapping for MPI_Comm_delete_attr_function not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_Comm_errhandler_function),
               "Naive mapping for MPI_Comm_errhandler_function not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_Copy_function),
               "Naive mapping for MPI_Copy_function not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_Count),
               "Naive mapping for MPI_Count not working!");
_Static_assert(
    sizeof(void *) >= sizeof(MPI_Datarep_conversion_function),
    "Naive mapping for MPI_Datarep_conversion_function not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_Datarep_extent_function),
               "Naive mapping for MPI_Datarep_extent_function not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_File_errhandler_function),
               "Naive mapping for MPI_File_errhandler_function not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_Fint),
               "Naive mapping for MPI_Fint not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_Grequest_cancel_function),
               "Naive mapping for MPI_Grequest_cancel_function not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_Grequest_free_function),
               "Naive mapping for MPI_Grequest_free_function not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_Grequest_query_function),
               "Naive mapping for MPI_Grequest_query_function not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_Handler_function),
               "Naive mapping for MPI_Handler_function not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_T_cvar_handle),
               "Naive mapping for MPI_T_cvar_handle not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_T_enum),
               "Naive mapping for MPI_T_enum not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_T_pvar_handle),
               "Naive mapping for MPI_T_pvar_handle not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_T_pvar_session),
               "Naive mapping for MPI_T_pvar_session not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_Type_copy_attr_function),
               "Naive mapping for MPI_Type_copy_attr_function not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_Type_delete_attr_function),
               "Naive mapping for MPI_Type_delete_attr_function not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_Win_copy_attr_function),
               "Naive mapping for MPI_Win_copy_attr_function not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_Win_delete_attr_function),
               "Naive mapping for MPI_Win_delete_attr_function not working!");
_Static_assert(sizeof(void *) >= sizeof(MPI_Win_errhandler_function),
...
int mpi_Scatterv(const void *sendbuf, const int *sendcounts, const int *displs,
                 void *sendtype, void *recvbuf, int recvcount, void *recvtype,
                 int root, void *comm) {
  MPI_Datatype sendtype_ = sendtype;
  MPI_Datatype recvtype_ = recvtype;
  MPI_Comm comm_ = comm;
  int ret = MPI_Scatterv(sendbuf, sendcounts, displs, sendtype_, recvbuf,
                         recvcount, recvtype_, root, comm_);
  sendtype = sendtype_;
  recvtype = recvtype_;
  comm = comm_;
  return ret;
...
int mpi_Send(const void *buf, int count, void *datatype, int dest, int tag,
             void *comm) {
  MPI_Datatype datatype_ = datatype;
  MPI_Comm comm_ = comm;
...
int mpi_Send_init(const void *buf, int count, void *datatype, int dest, int tag,
...
int mpi_Sendrecv(
  ...
  MPI_Comm comm_ = comm;
  MPI_Status *status_ = status;
  int ret = MPI_Sendrecv(sendbuf, sendcount, sendtype_, dest, sendtag, recvbuf,
                         recvcount, recvtype_, source, recvtag, comm_, status_);
  sendtype = sendtype_;
  recvtype = recvtype_;
  comm = comm_;
  status = status_;
...
int mpi_Accumulate(const void *origin_addr, int origin_count,
                   ...
                   MPI_Datatype target_datatype, void *op, void *win) {
  ...
  MPI_Win win_ = win;
  int ret =
      MPI_Accumulate(origin_addr, origin_count, origin_datatype_, target_rank,
                     target_disp_, target_count, target_datatype_, op_, win_);
...
int mpi_Sendrecv_replace(
  ...
  MPI_Comm comm_ = comm;
  MPI_Status *status_ = status;
  int ret = MPI_Sendrecv_replace(buf, count, datatype_, dest, sendtag, source,
                                 recvtag, comm_, status_);
  datatype = datatype_;
  comm = comm_;
  status = status_;
  return ret;
...
int mpi_File_write_at_all_begin(void *fh, void *offset, void *buf, int count,
                                void *datatype) {
  MPI_File fh_ = fh;
  MPI_Offset offset_ = offset;
  MPI_Datatype datatype_ = datatype;
...
int mpi_Ssend(const void *buf, int count, void *datatype, int dest, int tag,
              void *comm) {
  MPI_Datatype datatype_ = datatype;
  MPI_Comm comm_ = comm;
...
int mpi_Ssend_init(const void *buf, int count, void *datatype, int dest,
                   int tag, void *comm, void **request) {
  MPI_Datatype datatype_ = datatype;
  MPI_Comm comm_ = comm;
  MPI_Request *request_ = request;
...
int mpi_File_write_ordered_begin(void *fh, void *buf, int count,
                                 void *datatype) {
  MPI_File fh_ = fh;
  MPI_Datatype datatype_ = datatype;
...
int mpi_Allgather(const void *sendbuf, int sendcount, void *sendtype,
                  void *recvbuf, int recvcount, void *recvtype, void *comm) {
  MPI_Datatype sendtype_ = sendtype;
  MPI_Datatype recvtype_ = recvtype;
  MPI_Comm comm_ = comm;
  int ret = MPI_Allgather(sendbuf, sendcount, sendtype_, recvbuf, recvcount,
                          recvtype_, comm_);
  sendtype = sendtype_;
  recvtype = recvtype_;
  comm = comm_;
...
int mpi_Allgatherv(const void *sendbuf, int sendcount, void *sendtype,
                   void *recvbuf, const int *recvcounts, const int *displs,
                   void *recvtype, void *comm) {
  MPI_Datatype sendtype_ = sendtype;
  MPI_Datatype recvtype_ = recvtype;
  MPI_Comm comm_ = comm;
  int ret = MPI_Allgatherv(sendbuf, sendcount, sendtype_, recvbuf, recvcounts,
                           displs, recvtype_, comm_);
  sendtype = sendtype_;
  recvtype = recvtype_;
  comm = comm_;
  return ret;
...
int mpi_Allreduce(const void *sendbuf, void *recvbuf, int count, void *datatype,
                  void *op, void *comm) {
  MPI_Datatype datatype_ = datatype;
  MPI_Op op_ = op;
  MPI_Comm comm_ = comm;
...
int mpi_Alltoall(const void *sendbuf, int sendcount, void *sendtype,
                 void *recvbuf, int recvcount, void *recvtype, void *comm) {
  MPI_Datatype sendtype_ = sendtype;
  MPI_Datatype recvtype_ = recvtype;
  MPI_Comm comm_ = comm;
  int ret = MPI_Alltoall(sendbuf, sendcount, sendtype_, recvbuf, recvcount,
                         recvtype_, comm_);
  sendtype = sendtype_;
  recvtype = recvtype_;
  comm = comm_;
...
int mpi_Alltoallv(const void *sendbuf, const int *sendcounts,
                  const int *sdispls, void *sendtype, void *recvbuf,
                  const int *recvcounts, const int *rdispls, void *recvtype,
                  void *comm) {
  MPI_Datatype sendtype_ = sendtype;
  MPI_Datatype recvtype_ = recvtype;
  MPI_Comm comm_ = comm;
  int ret = MPI_Alltoallv(sendbuf, sendcounts, sdispls, sendtype_, recvbuf,
                          recvcounts, rdispls, recvtype_, comm_);
  sendtype = sendtype_;
  recvtype = recvtype_;
  comm = comm_;
  return ret;
...
int mpi_Gather(const void *sendbuf, int sendcount, void *sendtype,
               void *recvbuf, int recvcount, void *recvtype, int root,
               void *comm) {
  MPI_Datatype sendtype_ = sendtype;
  MPI_Datatype recvtype_ = recvtype;
  MPI_Comm comm_ = comm;
  int ret = MPI_Gather(sendbuf, sendcount, sendtype_, recvbuf, recvcount,
                       recvtype_, root, comm_);
  sendtype = sendtype_;
  recvtype = recvtype_;
  comm = comm_;
  return ret;
...
int mpi_Alltoallw(const void *sendbuf, const int sendcounts[],
                  const int sdispls[], const void *sendtypes[], void *recvbuf,
                  const int recvcounts[], const int rdispls[],
                  const void *recvtypes[], void *comm) {
  fprintf(
      stderr,
      "MPI_Alltoallw is not implementented in MultiMPI - use MPI directly\n");
  ...
  MPI_Abort(MPI_COMM_WORLD, 1);
  MPI_Comm comm_ = comm;
  int ret = MPI_Alltoallw(sendbuf, sendcounts, sdispls, sendtypes, recvbuf,
                          recvcounts, rdispls, recvtypes, comm_);
  comm = comm_;
  return ret;
}

int mpi_Gatherv(const void *sendbuf, int sendcount, void *sendtype,
                void *recvbuf, const int *recvcounts, const int *displs,
                void *recvtype, int root, void *comm) {
  MPI_Datatype sendtype_ = sendtype;
  MPI_Datatype recvtype_ = recvtype;
  MPI_Comm comm_ = comm;
  int ret = MPI_Gatherv(sendbuf, sendcount, sendtype_, recvbuf, recvcounts,
                        displs, recvtype_, root, comm_);
  sendtype = sendtype_;
  recvtype = recvtype_;
  comm = comm_;
  return ret;
...
int mpi_T_category_get_info(int cat_index, char *name, int *name_len,
  ...
  int ret = MPI_T_category_get_info(cat_index, name, name_len, desc, desc_len,
...
int mpi_Get(void *origin_addr, int origin_count, MPI_Datatype origin_datatype,
            int target_rank, void *target_disp, int target_count,
            void *target_datatype, MPI_Win win) {
  MPI_Datatype origin_datatype_ = origin_datatype;
  MPI_Aint target_disp_ = target_disp;
  MPI_Datatype target_datatype_ = target_datatype;
  MPI_Win win_ = win;
  int ret = MPI_Get(origin_addr, origin_count, origin_datatype_, target_rank,
                    target_disp_, target_count, target_datatype_, win_);
  origin_datatype = origin_datatype_;
  target_disp = target_disp_;
  target_datatype = target_datatype_;
  win = win_;
...
int mpi_Get_accumulate(const void *origin_addr, int origin_count,
                       void *origin_datatype, void *result_addr,
                       int result_count, void *result_datatype, int target_rank,
                       void *target_disp, int target_count,
                       void *target_datatype, void *op, void *win) {
  MPI_Datatype origin_datatype_ = origin_datatype;
  ...
  MPI_Op op_ = op;
  MPI_Win win_ = win;
  int ret = MPI_Get_accumulate(origin_addr, origin_count, origin_datatype_,
                               result_addr, result_count, result_datatype_,
                               target_rank, target_disp_, target_count,
                               target_datatype_, op_, win_);
  origin_datatype = origin_datatype_;
...
int mpi_T_cvar_get_info(int cvar_index, char *name, int *name_len,
                        int *verbosity, void **datatype, void **enumtype,
                        char *desc, int *desc_len, int *binding, int *scope) {
  MPI_Datatype *datatype_ = datatype;
  MPI_T_enum *enumtype_ = enumtype;
  int ret =
      MPI_T_cvar_get_info(cvar_index, name, name_len, verbosity, datatype_,
                          enumtype_, desc, desc_len, binding, scope);
  datatype = datatype_;
  enumtype = enumtype_;
  return ret;
}
...
int mpi_T_cvar_handle_alloc(int cvar_index, void *obj_handle, void **handle,
                            int *count) {
...
int mpi_Bsend(const void *buf, int count, void *datatype, int dest, int tag,
              void *comm) {
  MPI_Datatype datatype_ = datatype;
  MPI_Comm comm_ = comm;
...
int mpi_Bsend_init(const void *buf, int count, void *datatype, int dest,
                   int tag, void *comm, void **request) {
  MPI_Datatype datatype_ = datatype;
  MPI_Comm comm_ = comm;
  MPI_Request *request_ = request;
...
int mpi_Graph_create(void *comm_old, int nnodes, const int indx[],
                     const int edges[], int reorder, void **comm_graph) {
  MPI_Comm comm_old_ = comm_old;
  MPI_Comm *comm_graph_ = comm_graph;
  int ret =
      MPI_Graph_create(comm_old_, nnodes, indx, edges, reorder, comm_graph_);
  comm_old = comm_old_;
  comm_graph = comm_graph_;
  return ret;
}

int mpi_T_enum_get_item(void *enumtype, int index, int *value, char *name,
                        int *name_len) {
  MPI_T_enum enumtype_ = enumtype;
...
int mpi_Graph_get(void *comm, int maxindex, int maxedges, int indx[],
                  int edges[]) {
  MPI_Comm comm_ = comm;
...
int mpi_Cart_create(void *comm_old, int ndims, const int dims[],
                    const int periods[], int reorder, void **comm_cart) {
  MPI_Comm comm_old_ = comm_old;
  MPI_Comm *comm_cart_ = comm_cart;
  int ret =
      MPI_Cart_create(comm_old_, ndims, dims, periods, reorder, comm_cart_);
  comm_old = comm_old_;
  comm_cart = comm_cart_;
  return ret;
}

int mpi_Graph_map(void *comm, int nnodes, const int indx[], const int edges[],
                  int *newrank) {
  MPI_Comm comm_ = comm;
...
int mpi_Cart_get(void *comm, int maxdims, int dims[], int periods[],
                 int coords[]) {
  MPI_Comm comm_ = comm;
...
int mpi_Graph_neighbors(void *comm, int rank, int maxneighbors,
                        int neighbors[]) {
  MPI_Comm comm_ = comm;
...
int mpi_T_pvar_get_info(int pvar_index, char *name, int *name_len,
                        int *verbosity, int *var_class, void **datatype,
                        void **enumtype, char *desc, int *desc_len,
                        int *binding, int *readonly, int *continuous,
                        int *atomic) {
  MPI_Datatype *datatype_ = datatype;
  MPI_T_enum *enumtype_ = enumtype;
  int ret = MPI_T_pvar_get_info(pvar_index, name, name_len, verbosity,
                                var_class, datatype_, enumtype_, desc, desc_len,
...
int mpi_Cart_map(void *comm, int ndims, const int dims[], const int periods[],
                 int *newrank) {
  MPI_Comm comm_ = comm;
...
int mpi_T_pvar_handle_alloc(void *session, int pvar_index, void *obj_handle,
                            void **handle, int *count) {
  MPI_T_pvar_session session_ = session;
  MPI_T_pvar_handle *handle_ = handle;
  int ret =
      MPI_T_pvar_handle_alloc(session_, pvar_index, obj_handle, handle_, count);
  session = session_;
  handle = handle_;
  return ret;
}

int mpi_Cart_shift(void *comm, int direction, int disp, int *rank_source,
                   int *rank_dest) {
  MPI_Comm comm_ = comm;
...
int mpi_Grequest_start(void **query_fn, void **free_fn, void **cancel_fn,
                       void *extra_state, void **request) {
  ...
  MPI_Request *request_ = request;
  int ret = MPI_Grequest_start(query_fn_, free_fn_, cancel_fn_, extra_state,
                               request_);
  query_fn = query_fn_;
  free_fn = free_fn_;
...
int mpi_Comm_accept(const char *port_name, void *info, int root, void *comm,
                    void **newcomm) {
  MPI_Info info_ = info;
  MPI_Comm comm_ = comm;
  MPI_Comm *newcomm_ = newcomm;
...
int mpi_Comm_connect(const char *port_name, void *info, int root, void *comm,
                     void **newcomm) {
  MPI_Info info_ = info;
  MPI_Comm comm_ = comm;
  MPI_Comm *newcomm_ = newcomm;
...
int mpi_Comm_create_keyval(void **comm_copy_attr_fn, void **comm_delete_attr_fn,
  ...
  int ret = MPI_Comm_create_keyval(comm_copy_attr_fn_, comm_delete_attr_fn_,
...
int mpi_Group_translate_ranks(void *group1, int n, const int ranks1[],
                              void *group2, int ranks2[]) {
  MPI_Group group1_ = group1;
  MPI_Group group2_ = group2;
...
int mpi_Testsome(
  ...
  int ret = MPI_Testsome(incount, array_of_requests_, outcount,
                         array_of_indices, array_of_statuses_);
  for (int i = 0; i < incount; ++i) {
    array_of_requests_[i] = array_of_requests[i];
  }
  for (int i = 0; i < *outcount; ++i) {
...
int mpi_Iallgather(const void *sendbuf, int sendcount, void *sendtype,
                   void *recvbuf, int recvcount, void *recvtype, void *comm,
                   void **request) {
  MPI_Datatype sendtype_ = sendtype;
  MPI_Datatype recvtype_ = recvtype;
  MPI_Comm comm_ = comm;
  MPI_Request *request_ = request;
  int ret = MPI_Iallgather(sendbuf, sendcount, sendtype_, recvbuf, recvcount,
                           recvtype_, comm_, request_);
  sendtype = sendtype_;
  recvtype = recvtype_;
  comm = comm_;
  request = request_;
...
int mpi_Iallgatherv(const void *sendbuf, int sendcount, void *sendtype,
                    void *recvbuf, const int recvcounts[], const int displs[],
                    void *recvtype, void *comm, void **request) {
  MPI_Datatype sendtype_ = sendtype;
  MPI_Datatype recvtype_ = recvtype;
  MPI_Comm comm_ = comm;
  MPI_Request *request_ = request;
  int ret = MPI_Iallgatherv(sendbuf, sendcount, sendtype_, recvbuf, recvcounts,
                            displs, recvtype_, comm_, request_);
  sendtype = sendtype_;
  recvtype = recvtype_;
  comm = comm_;
  request = request_;
...
int mpi_Iallreduce(const void *sendbuf, void *recvbuf, int count,
                   void *datatype, void *op, void *comm, void **request) {
  MPI_Datatype datatype_ = datatype;
  MPI_Op op_ = op;
  MPI_Comm comm_ = comm;
  MPI_Request *request_ = request;
  int ret =
      MPI_Iallreduce(sendbuf, recvbuf, count, datatype_, op_, comm_, request_);
  datatype = datatype_;
  op = op_;
  comm = comm_;
  request = request_;
...
int mpi_Ialltoall(const void *sendbuf, int sendcount, void *sendtype,
                  void *recvbuf, int recvcount, void *recvtype, void *comm,
                  void **request) {
  MPI_Datatype sendtype_ = sendtype;
  MPI_Datatype recvtype_ = recvtype;
  MPI_Comm comm_ = comm;
  MPI_Request *request_ = request;
  int ret = MPI_Ialltoall(sendbuf, sendcount, sendtype_, recvbuf, recvcount,
                          recvtype_, comm_, request_);
  sendtype = sendtype_;
  recvtype = recvtype_;
  comm = comm_;
...
int mpi_Type_create_darray(int size, int rank, int ndims,
                           ...
                           void *oldtype, void **newtype) {
  MPI_Datatype oldtype_ = oldtype;
  MPI_Datatype *newtype_ = newtype;
  int ret = MPI_Type_create_darray(size, rank, ndims, array_of_gsizes,
                                   array_of_distribs, array_of_dargs,
                                   array_of_psizes, order, oldtype_, newtype_);
  oldtype = oldtype_;
  newtype = newtype_;
  return ret;
}

int mpi_Comm_get_attr(void *comm, int comm_keyval, void *attribute_val,
                      int *flag) {
  MPI_Comm comm_ = comm;
...
int mpi_Ialltoallv(const void *sendbuf, const int sendcounts[],
  ...
  MPI_Comm comm_ = comm;
  MPI_Request *request_ = request;
  int ret = MPI_Ialltoallv(sendbuf, sendcounts, sdispls, sendtype_, recvbuf,
                           recvcounts, rdispls, recvtype_, comm_, request_);
  sendtype = sendtype_;
  recvtype = recvtype_;
  comm = comm_;
  request = request_;
...
int mpi_Ialltoallw(const void *sendbuf, const int sendcounts[],
                   const int sdispls[], const void *sendtypes[], void *recvbuf,
                   const int recvcounts[], const int rdispls[],
                   const void *recvtypes[], void *comm, void **request) {
  fprintf(
      stderr,
      "MPI_Ialltoallw is not implementented in MultiMPI - use MPI directly\n");
  MPI_Abort(MPI_COMM_WORLD, 1);
  fprintf(
      stderr,
      "MPI_Ialltoallw is not implementented in MultiMPI - use MPI directly\n");
  ...
  MPI_Comm comm_ = comm;
  MPI_Request *request_ = request;
  int ret = MPI_Ialltoallw(sendbuf, sendcounts, sdispls, sendtypes, recvbuf,
                           recvcounts, rdispls, recvtypes, comm_, request_);
  comm = comm_;
  request = request_;
  return ret;
}
...
int mpi_Ibcast(void *buffer, int count, void *datatype, int root, void *comm,
               void **request) {
  MPI_Datatype datatype_ = datatype;
  MPI_Comm comm_ = comm;
  MPI_Request *request_ = request;
...
int mpi_Type_create_hindexed(int count, const int array_of_blocklengths[],
  ...
  int ret =
      MPI_Type_create_hindexed(count, array_of_blocklengths,
                               array_of_displacements_, oldtype_, newtype_);
  for (int i = 0; i < count; ++i) {
    array_of_displacements_[i] = array_of_displacements[i];
  }
  oldtype = oldtype_;
...
int mpi_Ibsend(const void *buf, int count, void *datatype, int dest, int tag,
               void *comm, void **request) {
  MPI_Datatype datatype_ = datatype;
  MPI_Comm comm_ = comm;
  MPI_Request *request_ = request;
...
int mpi_Type_create_hindexed_block(int count, int blocklength,
  ...
  int ret = MPI_Type_create_hindexed_block(
      count, blocklength, array_of_displacements_, oldtype_, newtype_);
  for (int i = 0; i < count; ++i) {
    array_of_displacements_[i] = array_of_displacements[i];
  }
  oldtype = oldtype_;
...
int mpi_Iexscan(const void *sendbuf, void *recvbuf, int count, void *datatype,
  ...
  MPI_Request *request_ = request;
  int ret =
      MPI_Iexscan(sendbuf, recvbuf, count, datatype_, op_, comm_, request_);
  datatype = datatype_;
  op = op_;
  comm = comm_;
  request = request_;
...
int mpi_Type_create_hvector(int count, int blocklength, void *stride,
                            void *oldtype, void **newtype) {
  MPI_Aint stride_ = stride;
  MPI_Datatype oldtype_ = oldtype;
  MPI_Datatype *newtype_ = newtype;
  int ret =
      MPI_Type_create_hvector(count, blocklength, stride_, oldtype_, newtype_);
  stride = stride_;
  oldtype = oldtype_;
  newtype = newtype_;
  return ret;
...
int mpi_Igather(const void *sendbuf, int sendcount, void *sendtype,
                void *recvbuf, int recvcount, void *recvtype, int root,
                void *comm, void **request) {
  MPI_Datatype sendtype_ = sendtype;
  MPI_Datatype recvtype_ = recvtype;
  MPI_Comm comm_ = comm;
  MPI_Request *request_ = request;
  int ret = MPI_Igather(sendbuf, sendcount, sendtype_, recvbuf, recvcount,
                        recvtype_, root, comm_, request_);
  sendtype = sendtype_;
  recvtype = recvtype_;
  comm = comm_;
  request = request_;
...
int mpi_Type_create_indexed_block(int count, int blocklength,
  ...
  MPI_Datatype oldtype_ = oldtype;
  MPI_Datatype *newtype_ = newtype;
  int ret = MPI_Type_create_indexed_block(
      count, blocklength, array_of_displacements, oldtype_, newtype_);
  oldtype = oldtype_;
  newtype = newtype_;
  return ret;
}
...
int mpi_Igatherv(const void *sendbuf, int sendcount, void *sendtype,
                 void *recvbuf, const int recvcounts[], const int displs[],
                 void *recvtype, int root, void *comm, void **request) {
  MPI_Datatype sendtype_ = sendtype;
  MPI_Datatype recvtype_ = recvtype;
  MPI_Comm comm_ = comm;
  MPI_Request *request_ = request;
  int ret = MPI_Igatherv(sendbuf, sendcount, sendtype_, recvbuf, recvcounts,
                         displs, recvtype_, root, comm_, request_);
  sendtype = sendtype_;
  recvtype = recvtype_;
  comm = comm_;
  request = request_;
...
int mpi_Type_create_keyval(void **type_copy_attr_fn, void **type_delete_attr_fn,
  ...
  int ret = MPI_Type_create_keyval(type_copy_attr_fn_, type_delete_attr_fn_,
...
int mpi_Type_create_resized(void *oldtype, void *lb, void *extent,
                            void **newtype) {
  MPI_Datatype oldtype_ = oldtype;
  MPI_Aint lb_ = lb;
...
int mpi_Imrecv(void *buf, int count, void *datatype, void **message,
               void **request) {
  MPI_Datatype datatype_ = datatype;
  MPI_Message *message_ = message;
  MPI_Request *request_ = request;
...
int mpi_Type_create_struct(int count, const int array_of_blocklengths[],
                           const void *array_of_displacements[],
                           const void *array_of_types[], void **newtype) {
  MPI_Aint array_of_displacements_[count];
  ...
  int ret = MPI_Type_create_struct(count, array_of_blocklengths,
                                   array_of_displacements_, array_of_types_,
                                   newtype_);
  for (int i = 0; i < count; ++i) {
    array_of_displacements_[i] = array_of_displacements[i];
    array_of_types_[i] = array_of_types[i];
...
int mpi_Ineighbor_allgather(const void *sendbuf, int sendcount, void *sendtype,
                            void *recvbuf, int recvcount, void *recvtype,
                            void *comm, void **request) {
  MPI_Datatype sendtype_ = sendtype;
  MPI_Datatype recvtype_ = recvtype;
  MPI_Comm comm_ = comm;
  MPI_Request *request_ = request;
  int ret = MPI_Ineighbor_allgather(sendbuf, sendcount, sendtype_, recvbuf,
                                    recvcount, recvtype_, comm_, request_);
  sendtype = sendtype_;
  recvtype = recvtype_;
  comm = comm_;
  request = request_;
...
int mpi_Type_create_subarray(int ndims, const int array_of_sizes[],
  ...
  int ret =
      MPI_Type_create_subarray(ndims, array_of_sizes, array_of_subsizes,
                               array_of_starts, order, oldtype_, newtype_);
  oldtype = oldtype_;
  newtype = newtype_;
  return ret;
}
...
int mpi_Ineighbor_allgatherv(const void *sendbuf, int sendcount, void *sendtype,
                             void *recvbuf, const int recvcounts[],
                             const int displs[], void *recvtype, void *comm,
                             void **request) {
  MPI_Datatype sendtype_ = sendtype;
  MPI_Datatype recvtype_ = recvtype;
  MPI_Comm comm_ = comm;
  MPI_Request *request_ = request;
  int ret =
      MPI_Ineighbor_allgatherv(sendbuf, sendcount, sendtype_, recvbuf,
                               recvcounts, displs, recvtype_, comm_, request_);
  sendtype = sendtype_;
  recvtype = recvtype_;
  comm = comm_;
  request = request_;
...
int mpi_Ineighbor_alltoall(const void *sendbuf, int sendcount, void *sendtype,
                           void *recvbuf, int recvcount, void *recvtype,
                           void *comm, void **request) {
  MPI_Datatype sendtype_ = sendtype;
  MPI_Datatype recvtype_ = recvtype;
  MPI_Comm comm_ = comm;
  MPI_Request *request_ = request;
  int ret = MPI_Ineighbor_alltoall(sendbuf, sendcount, sendtype_, recvbuf,
                                   recvcount, recvtype_, comm_, request_);
  sendtype = sendtype_;
  recvtype = recvtype_;
  comm = comm_;
...
int mpi_Ineighbor_alltoallv(const void *sendbuf, const int sendcounts[],
  ...
  MPI_Request *request_ = request;
  int ret =
      MPI_Ineighbor_alltoallv(sendbuf, sendcounts, sdispls, sendtype_, recvbuf,
                              recvcounts, rdispls, recvtype_, comm_, request_);
  sendtype = sendtype_;
  recvtype = recvtype_;
  comm = comm_;
...
int mpi_Ineighbor_alltoallw(const void *sendbuf, const int sendcounts[],
                            const void *sdispls[], const void *sendtypes[],
                            void *recvbuf, const int recvcounts[],
                            const void *rdispls[], const void *recvtypes[],
                            void *comm, void **request) {
  fprintf(stderr, "MPI_Ineighbor_alltoallw is not implementented in MultiMPI - "
                  "use MPI directly\n");
  MPI_Abort(MPI_COMM_WORLD, 1);
  fprintf(stderr, "MPI_Ineighbor_alltoallw is not implementented in MultiMPI - "
                  "use MPI directly\n");
...
int mpi_Comm_spawn(const char *command, char *argv[], int maxprocs, void *info,
                   int root, void *comm, void **intercomm,
                   int array_of_errcodes[]) {
  MPI_Info info_ = info;
  MPI_Comm comm_ = comm;
  MPI_Comm *intercomm_ = intercomm;
  int ret = MPI_Comm_spawn(command, argv, maxprocs, info_, root, comm_,
                           intercomm_, array_of_errcodes);
  info = info_;
  comm = comm_;
  intercomm = intercomm_;
  return ret;
...
int mpi_Type_get_attr(void *datatype, int type_keyval, void *attribute_val,
                      int *flag) {
  MPI_Datatype datatype_ = datatype;
...
int mpi_Comm_spawn_multiple(int count, char *array_of_commands[],
                            ...
                            const void *array_of_info[], int root, void *comm,
                            void **intercomm, int array_of_errcodes[]) {
  ...
  int ret = MPI_Comm_spawn_multiple(count, array_of_commands, array_of_argv,
                                    array_of_maxprocs, array_of_info_, root,
                                    comm_, intercomm_, array_of_errcodes);
  for (int i = 0; i < count; ++i) {
    array_of_info_[i] = array_of_info[i];
  }
  comm = comm_;
...
int mpi_Type_get_contents(void *datatype, int max_integers, int max_addresses,
  ...
  int ret = MPI_Type_get_contents(datatype_, max_integers, max_addresses,
                                  max_datatypes, array_of_integers,
                                  array_of_addresses_, array_of_datatypes_);
  for (int i = 0; i < max_addresses; ++i) {
    array_of_addresses_[i] = array_of_addresses[i];
  }
  for (int i = 0; i < max_datatypes; ++i) {
...
int mpi_Type_get_envelope(void *datatype, int *num_integers, int *num_addresses,
                          int *num_datatypes, int *combiner) {
  MPI_Datatype datatype_ = datatype;
  int ret = MPI_Type_get_envelope(datatype_, num_integers, num_addresses,
                                  num_datatypes, combiner);
  datatype = datatype_;
  return ret;
}

int mpi_Comm_split_type(void *comm, int split_type, int key, void *info,
                        void **newcomm) {
  MPI_Comm comm_ = comm;
  MPI_Info info_ = info;
  MPI_Comm *newcomm_ = newcomm;
...
int mpi_Info_get(void *info, const char *key, int valuelen, char *value,
                 int *flag) {
  MPI_Info info_ = info;
...
int mpi_Compare_and_swap(const void *origin_addr, const void *compare_addr,
                         void *result_addr, void *datatype, int target_rank,
                         void *target_disp, void *win) {
  MPI_Datatype datatype_ = datatype;
  MPI_Aint target_disp_ = target_disp;
  MPI_Win win_ = win;
  int ret = MPI_Compare_and_swap(origin_addr, compare_addr, result_addr,
                                 datatype_, target_rank, target_disp_, win_);
  datatype = datatype_;
  target_disp = target_disp_;
  win = win_;
  return ret;
...
int mpi_Info_get_valuelen(void *info, const char *key, int *valuelen,
                          int *flag) {
  MPI_Info info_ = info;
...
int mpi_Type_get_true_extent(void *datatype, void **true_lb,
                             void **true_extent) {
  MPI_Datatype datatype_ = datatype;
...
int mpi_Dist_graph_create(void *comm_old, int n, const int sources[],
                          const int degrees[], const int destinations[],
                          const int weights[], void *info, int reorder,
                          void **comm_dist_graph) {
  MPI_Comm comm_old_ = comm_old;
  MPI_Info info_ = info;
  MPI_Comm *comm_dist_graph_ = comm_dist_graph;
  int ret = MPI_Dist_graph_create(comm_old_, n, sources, degrees, destinations,
                                  weights, info_, reorder, comm_dist_graph_);
  comm_old = comm_old_;
  info = info_;
...
int mpi_Type_get_true_extent_x(void *datatype, void **true_lb,
                               void **true_extent) {
  MPI_Datatype datatype_ = datatype;
...
int mpi_Dist_graph_create_adjacent(void *comm_old, int indegree,
                                   const int sources[],
                                   const int sourceweights[], int outdegree,
                                   const int destinations[],
                                   const int destweights[], void *info,
                                   int reorder, void **comm_dist_graph) {
  MPI_Comm comm_old_ = comm_old;
  MPI_Info info_ = info;
  MPI_Comm *comm_dist_graph_ = comm_dist_graph;
  int ret = MPI_Dist_graph_create_adjacent(
      comm_old_, indegree, sources, sourceweights, outdegree, destinations,
      destweights, info_, reorder, comm_dist_graph_);
  comm_old = comm_old_;
  info = info_;
  comm_dist_graph = comm_dist_graph_;
  return ret;
...
int mpi_Type_hindexed(int count, const int *array_of_blocklengths,
                      const void **array_of_displacements, void *oldtype,
                      void **newtype) {
  MPI_Aint array_of_displacements_[count];
  MPI_Datatype oldtype_ = oldtype;
  MPI_Datatype *newtype_ = newtype;
  ...
  int ret = MPI_Type_hindexed(count, array_of_blocklengths,
                              array_of_displacements_, oldtype_, newtype_);
  for (int i = 0; i < count; ++i) {
    array_of_displacements_[i] = array_of_displacements[i];
  }
...
int mpi_Dist_graph_neighbors(void *comm, int maxindegree, int sources[],
                             int sourceweights[], int maxoutdegree,
                             int destinations[], int destweights[]) {
  MPI_Comm comm_ = comm;
  int ret = MPI_Dist_graph_neighbors(comm_, maxindegree, sources, sourceweights,
...
int mpi_Type_hvector(int count, int blocklength, void *stride, void *oldtype,
                     void **newtype) {
  MPI_Aint stride_ = stride;
  MPI_Datatype oldtype_ = oldtype;
  MPI_Datatype *newtype_ = newtype;
...
int mpi_Dist_graph_neighbors_count(void *comm, int *indegree, int *outdegree,
                                   int *weighted) {
  MPI_Comm comm_ = comm;
  int ret =
      MPI_Dist_graph_neighbors_count(comm_, indegree, outdegree, weighted);
  comm = comm_;
  return ret;
}
...
int mpi_Type_indexed(int count, const int *array_of_blocklengths,
                     const int *array_of_displacements, void *oldtype,
                     void **newtype) {
  MPI_Datatype oldtype_ = oldtype;
  MPI_Datatype *newtype_ = newtype;
  int ret = MPI_Type_indexed(count, array_of_blocklengths,
                             array_of_displacements, oldtype_, newtype_);
  oldtype = oldtype_;
  newtype = newtype_;
  return ret;
}
...
int mpi_Intercomm_create(void *local_comm, int local_leader, void *peer_comm,
                         int remote_leader, int tag, void **newintercomm) {
  MPI_Comm local_comm_ = local_comm;
  MPI_Comm peer_comm_ = peer_comm;
  MPI_Comm *newintercomm_ = newintercomm;
  int ret = MPI_Intercomm_create(local_comm_, local_leader, peer_comm_,
                                 remote_leader, tag, newintercomm_);
...
int mpi_Irecv(void *buf, int count, void *datatype, int source, int tag,
              void *comm, void **request) {
  MPI_Datatype datatype_ = datatype;
  MPI_Comm comm_ = comm;
  MPI_Request *request_ = request;
...
int mpi_Ireduce(const void *sendbuf, void *recvbuf, int count, void *datatype,
                void *op, int root, void *comm, void **request) {
  MPI_Datatype datatype_ = datatype;
  MPI_Op op_ = op;
  MPI_Comm comm_ = comm;
  MPI_Request *request_ = request;
  int ret = MPI_Ireduce(sendbuf, recvbuf, count, datatype_, op_, root, comm_,
                        request_);
  datatype = datatype_;
  op = op_;
  comm = comm_;
...
int mpi_Ireduce_scatter(const void *sendbuf, void *recvbuf,
                        const int recvcounts[], void *datatype, void *op,
                        void *comm, void **request) {
  MPI_Datatype datatype_ = datatype;
  MPI_Op op_ = op;
  MPI_Comm comm_ = comm;
  MPI_Request *request_ = request;
  int ret = MPI_Ireduce_scatter(sendbuf, recvbuf, recvcounts, datatype_, op_,
                                comm_, request_);
  datatype = datatype_;
  op = op_;
  comm = comm_;
...
int mpi_Exscan(const void *sendbuf, void *recvbuf, int count, void *datatype,
               void *op, void *comm) {
  MPI_Datatype datatype_ = datatype;
  MPI_Op op_ = op;
  MPI_Comm comm_ = comm;
...
int mpi_Ireduce_scatter_block(const void *sendbuf, void *recvbuf, int recvcount,
  ...
  MPI_Comm comm_ = comm;
  MPI_Request *request_ = request;
  int ret = MPI_Ireduce_scatter_block(sendbuf, recvbuf, recvcount, datatype_,
                                      op_, comm_, request_);
  datatype = datatype_;
  op = op_;
  comm = comm_;
...
int mpi_Type_struct(int count, const int *array_of_blocklengths,
  ...
  int ret = MPI_Type_struct(count, array_of_blocklengths,
                            array_of_displacements_, array_of_types_, newtype_);
  for (int i = 0; i < count; ++i) {
    array_of_displacements_[i] = array_of_displacements[i];
    array_of_types_[i] = array_of_types[i];
  }
...
int mpi_Fetch_and_op(const void *origin_addr, void *result_addr, void *datatype,
                     int target_rank, void *target_disp, void *op, void *win) {
  MPI_Datatype datatype_ = datatype;
  MPI_Aint target_disp_ = target_disp;
  MPI_Op op_ = op;
  MPI_Win win_ = win;
  int ret = MPI_Fetch_and_op(origin_addr, result_addr, datatype_, target_rank,
                             target_disp_, op_, win_);
  datatype = datatype_;
  target_disp = target_disp_;
  op = op_;
  win = win_;
...
int mpi_Irsend(const void *buf, int count, void *datatype, int dest, int tag,
               void *comm, void **request) {
  MPI_Datatype datatype_ = datatype;
  MPI_Comm comm_ = comm;
  MPI_Request *request_ = request;
...
int mpi_Type_vector(int count, int blocklength, int stride, void *oldtype,
                    void **newtype) {
  MPI_Datatype oldtype_ = oldtype;
  MPI_Datatype *newtype_ = newtype;
...
int mpi_Iscan(const void *sendbuf, void *recvbuf, int count, void *datatype,
              void *op, void *comm, void **request) {
  MPI_Datatype datatype_ = datatype;
  MPI_Op op_ = op;
  MPI_Comm comm_ = comm;
...
int mpi_Unpack(const void *inbuf, int insize, int *position, void *outbuf,
               int outcount, void *datatype, void *comm) {
  MPI_Datatype datatype_ = datatype;
  MPI_Comm comm_ = comm;
  int ret =
      MPI_Unpack(inbuf, insize, position, outbuf, outcount, datatype_, comm_);
  datatype = datatype_;
  comm = comm_;
  return ret;
}
...
int mpi_Iscatter(const void *sendbuf, int sendcount, void *sendtype,
                 void *recvbuf, int recvcount, void *recvtype, int root,
                 void *comm, void **request) {
  MPI_Datatype sendtype_ = sendtype;
  MPI_Datatype recvtype_ = recvtype;
  MPI_Comm comm_ = comm;
  MPI_Request *request_ = request;
  int ret = MPI_Iscatter(sendbuf, sendcount, sendtype_, recvbuf, recvcount,
                         recvtype_, root, comm_, request_);
  sendtype = sendtype_;
  recvtype = recvtype_;
  comm = comm_;
...
int mpi_Unpack_external(const char datarep[], const void *inbuf, void *insize,
                        void **position, void *outbuf, int outcount,
                        void *datatype) {
  MPI_Aint insize_ = insize;
  MPI_Aint *position_ = position;
  MPI_Datatype datatype_ = datatype;
  int ret = MPI_Unpack_external(datarep, inbuf, insize_, position_, outbuf,
                                outcount, datatype_);
  insize = insize_;
  position = position_;
  datatype = datatype_;
...
int mpi_Iscatterv(const void *sendbuf, const int sendcounts[],
                  const int displs[], void *sendtype, void *recvbuf,
                  int recvcount, void *recvtype, int root, void *comm,
                  void **request) {
  MPI_Datatype sendtype_ = sendtype;
  MPI_Datatype recvtype_ = recvtype;
  MPI_Comm comm_ = comm;
  MPI_Request *request_ = request;
  int ret = MPI_Iscatterv(sendbuf, sendcounts, displs, sendtype_, recvbuf,
                          recvcount, recvtype_, root, comm_, request_);
  sendtype = sendtype_;
  recvtype = recvtype_;
  comm = comm_;
  request = request_;
...
int mpi_Unpublish_name(const char *service_name, void *info,
...
int mpi_Isend(const void *buf, int count, void *datatype, int dest, int tag,
              void *comm, void **request) {
  MPI_Datatype datatype_ = datatype;
  MPI_Comm comm_ = comm;
  MPI_Request *request_ = request;
...
int mpi_Issend(const void *buf, int count, void *datatype, int dest, int tag,
               void *comm, void **request) {
  MPI_Datatype datatype_ = datatype;
  MPI_Comm comm_ = comm;
  MPI_Request *request_ = request;
...
int mpi_Keyval_create(void **copy_fn, void **delete_fn, int *keyval,
                      void *extra_state) {
...
int mpi_Waitsome(
  ...
  int ret = MPI_Waitsome(incount, array_of_requests_, outcount,
                         array_of_indices, array_of_statuses_);
  for (int i = 0; i < incount; ++i) {
    array_of_requests_[i] = array_of_requests[i];
  }
...
int mpi_Win_allocate(void *size, int disp_unit, void *info, void *comm,
...
int mpi_Win_allocate_shared(void *size, int disp_unit, void *info, void *comm,
                            void *baseptr, void **win) {
  MPI_Aint size_ = size;
  MPI_Info info_ = info;
  MPI_Comm comm_ = comm;
  MPI_Win *win_ = win;
  int ret =
      MPI_Win_allocate_shared(size_, disp_unit, info_, comm_, baseptr, win_);
  size = size_;
  info = info_;
  comm = comm_;
  win = win_;
...
int mpi_Neighbor_allgather(const void *sendbuf, int sendcount, void *sendtype,
                           void *recvbuf, int recvcount, void *recvtype,
                           void *comm) {
  MPI_Datatype sendtype_ = sendtype;
  MPI_Datatype recvtype_ = recvtype;
  MPI_Comm comm_ = comm;
  int ret = MPI_Neighbor_allgather(sendbuf, sendcount, sendtype_, recvbuf,
                                   recvcount, recvtype_, comm_);
  sendtype = sendtype_;
  recvtype = recvtype_;
  comm = comm_;
  return ret;
...
int mpi_Neighbor_allgatherv(const void *sendbuf, int sendcount, void *sendtype,
                            void *recvbuf, const int recvcounts[],
                            const int displs[], void *recvtype, void *comm) {
  MPI_Datatype sendtype_ = sendtype;
  MPI_Datatype recvtype_ = recvtype;
  MPI_Comm comm_ = comm;
  int ret = MPI_Neighbor_allgatherv(sendbuf, sendcount, sendtype_, recvbuf,
                                    recvcounts, displs, recvtype_, comm_);
  sendtype = sendtype_;
  recvtype = recvtype_;
  comm = comm_;
  return ret;
...
int mpi_Neighbor_alltoall(const void *sendbuf, int sendcount, void *sendtype,
                          void *recvbuf, int recvcount, void *recvtype,
                          void *comm) {
  MPI_Datatype sendtype_ = sendtype;
  MPI_Datatype recvtype_ = recvtype;
  MPI_Comm comm_ = comm;
  int ret = MPI_Neighbor_alltoall(sendbuf, sendcount, sendtype_, recvbuf,
                                  recvcount, recvtype_, comm_);
  sendtype = sendtype_;
  recvtype = recvtype_;
  comm = comm_;
...
int mpi_Win_create(void *base, void *size, int disp_unit, void *info,
                   void *comm, void **win) {
  MPI_Aint size_ = size;
  MPI_Info info_ = info;
  MPI_Comm comm_ = comm;
...
int mpi_Neighbor_alltoallv(const void *sendbuf, const int sendcounts[],
  ...
  MPI_Comm comm_ = comm;
  int ret =
      MPI_Neighbor_alltoallv(sendbuf, sendcounts, sdispls, sendtype_, recvbuf,
                             recvcounts, rdispls, recvtype_, comm_);
  sendtype = sendtype_;
  recvtype = recvtype_;
  comm = comm_;
...
int mpi_Neighbor_alltoallw(const void *sendbuf, const int sendcounts[],
                           ...
                           const void *rdispls[], const void *recvtypes[],
                           void *comm) {
  fprintf(stderr, "MPI_Neighbor_alltoallw is not implementented in MultiMPI - "
                  "use MPI directly\n");
  MPI_Abort(MPI_COMM_WORLD, 1);
  fprintf(stderr, "MPI_Neighbor_alltoallw is not implementented in MultiMPI - "
                  "use MPI directly\n");
...
int mpi_File_get_view(void *fh, void **disp, void **etype, void **filetype,
                      char *datarep) {
  MPI_File fh_ = fh;
  MPI_Offset *disp_ = disp;
...
int mpi_Win_create_keyval(void **win_copy_attr_fn, void **win_delete_attr_fn,
  ...
  int ret = MPI_Win_create_keyval(win_copy_attr_fn_, win_delete_attr_fn_,
...
int mpi_File_iread(void *fh, void *buf, int count, void *datatype,
                   void **request) {
  MPI_File fh_ = fh;
  MPI_Datatype datatype_ = datatype;
  MPI_Request *request_ = request;
...
int mpi_File_iread_at(void *fh, void *offset, void *buf, int count,
                      void *datatype, void **request) {
  MPI_File fh_ = fh;
  MPI_Offset offset_ = offset;
  MPI_Datatype datatype_ = datatype;
...
int mpi_File_iread_shared(void *fh, void *buf, int count, void *datatype,
                          void **request) {
  MPI_File fh_ = fh;
  MPI_Datatype datatype_ = datatype;
  MPI_Request *request_ = request;
...
int mpi_File_iwrite(void *fh, void *buf, int count, void *datatype,
                    void **request) {
  MPI_File fh_ = fh;
  MPI_Datatype datatype_ = datatype;
  MPI_Request *request_ = request;
...
int mpi_Pack(const void *inbuf, int incount, void *datatype, void *outbuf,
             int outsize, int *position, void *comm) {
  MPI_Datatype datatype_ = datatype;
  MPI_Comm comm_ = comm;
  int ret =
      MPI_Pack(inbuf, incount, datatype_, outbuf, outsize, position, comm_);
  datatype = datatype_;
  comm = comm_;
  return ret;
}
...
int mpi_File_iwrite_at(void *fh, void *offset, void *buf, int count,
                       void *datatype, void **request) {
  MPI_File fh_ = fh;
  MPI_Offset offset_ = offset;
  MPI_Datatype datatype_ = datatype;
...
int mpi_Pack_external(const char datarep[], const void *inbuf, int incount,
                      void *datatype, void *outbuf, void *outsize,
                      void **position) {
  MPI_Datatype datatype_ = datatype;
  MPI_Aint outsize_ = outsize;
  MPI_Aint *position_ = position;
  int ret = MPI_Pack_external(datarep, inbuf, incount, datatype_, outbuf,
                              outsize_, position_);
  datatype = datatype_;
  outsize = outsize_;
  position = position_;
...
int mpi_File_iwrite_shared(void *fh, void *buf, int count, void *datatype,
                           void **request) {
  MPI_File fh_ = fh;
  MPI_Datatype datatype_ = datatype;
  MPIO_Request *request_ = request;
...
int mpi_Pack_external_size(const char datarep[], int incount, void *datatype,
                           void **size) {
  MPI_Datatype datatype_ = datatype;
  MPI_Aint *size_ = size;
...
int mpi_File_open(void *comm, char *filename, int amode, void *info,
                  void **fh) {
  MPI_Comm comm_ = comm;
  MPI_Info info_ = info;
  MPI_File *fh_ = fh;
...
int mpi_Publish_name(const char *service_name, void *info,
                     const char *port_name) {
  MPI_Info info_ = info;
...
int mpi_Win_get_attr(void *win, int win_keyval, void *attribute_val,
                     int *flag) {
  MPI_Win win_ = win;
...
int mpi_Put(const void *origin_addr, int origin_count,
            MPI_Datatype origin_datatype, int target_rank, void *target_disp,
            int target_count, void *target_datatype, MPI_Win win) {
  MPI_Datatype origin_datatype_ = origin_datatype;
  MPI_Aint target_disp_ = target_disp;
  MPI_Datatype target_datatype_ = target_datatype;
  MPI_Win win_ = win;
  int ret = MPI_Put(origin_addr, origin_count, origin_datatype_, target_rank,
                    target_disp_, target_count, target_datatype_, win_);
  origin_datatype = origin_datatype_;
  target_disp = target_disp_;
  target_datatype = target_datatype_;
...
int mpi_Raccumulate(const void *origin_addr, int origin_count,
  ...
  MPI_Win win_ = win;
  MPI_Request *request_ = request;
  int ret = MPI_Raccumulate(origin_addr, origin_count, origin_datatype_,
                            target_rank, target_disp_, target_count,
                            target_datatype_, op_, win_, request_);
  origin_datatype = origin_datatype_;
  target_disp = target_disp_;
  target_datatype = target_datatype_;
  op = op_;
...
int mpi_File_read_at_all_begin(void *fh, void *offset, void *buf, int count,
                               void *datatype) {
  MPI_File fh_ = fh;
  MPI_Offset offset_ = offset;
  MPI_Datatype datatype_ = datatype;
...
int mpi_Recv_init(void *buf, int count, void *datatype, int source, int tag,
                  void *comm, void **request) {
  MPI_Datatype datatype_ = datatype;
  MPI_Comm comm_ = comm;
  MPI_Request *request_ = request;
...
int mpi_Reduce(const void *sendbuf, void *recvbuf, int count, void *datatype,
               void *op, int root, void *comm) {
  MPI_Datatype datatype_ = datatype;
  MPI_Op op_ = op;
  MPI_Comm comm_ = comm;
...
int mpi_File_read_ordered_begin(void *fh, void *buf, int count,
                                void *datatype) {
  MPI_File fh_ = fh;
  MPI_Datatype datatype_ = datatype;
...
int mpi_Reduce_scatter(const void *sendbuf, void *recvbuf,
  ...
  MPI_Comm comm_ = comm;
  int ret =
      MPI_Reduce_scatter(sendbuf, recvbuf, recvcounts, datatype_, op_, comm_);
  datatype = datatype_;
  op = op_;
  comm = comm_;
  return ret;
...
int mpi_Reduce_scatter_block(const void *sendbuf, void *recvbuf, int recvcount,
  ...
  MPI_Op op_ = op;
  MPI_Comm comm_ = comm;
  int ret = MPI_Reduce_scatter_block(sendbuf, recvbuf, recvcount, datatype_,
                                     op_, comm_);
  datatype = datatype_;
  op = op_;
  comm = comm_;
...
int mpi_Register_datarep(char *datarep, void **read_conversion_fn,
  ...
  int ret =
      MPI_Register_datarep(datarep, read_conversion_fn_, write_conversion_fn_,
                           dtype_file_extent_fn_, extra_state);
...
int mpi_Win_shared_query(void *win, int rank, void **size, int *disp_unit,
                         void *baseptr) {
  MPI_Win win_ = win;
  MPI_Aint *size_ = size;
...
int mpi_Rget(void *origin_addr, int origin_count, MPI_Datatype origin_datatype,
             int target_rank, void *target_disp, int target_count,
             void *target_datatype, MPI_Win win, void **request) {
  MPI_Datatype origin_datatype_ = origin_datatype;
  MPI_Aint target_disp_ = target_disp;
  MPI_Datatype target_datatype_ = target_datatype;
  MPI_Win win_ = win;
  MPI_Request *request_ = request;
  int ret =
      MPI_Rget(origin_addr, origin_count, origin_datatype_, target_rank,
               target_disp_, target_count, target_datatype_, win_, request_);
  origin_datatype = origin_datatype_;
  target_disp = target_disp_;
  target_datatype = target_datatype_;
  win = win_;
...
int mpi_Rget_accumulate(const void *origin_addr, int origin_count,
                        void *origin_datatype, void *result_addr,
                        int result_count, void *result_datatype,
                        int target_rank, void *target_disp, int target_count,
                        void *target_datatype, void *op, void *win,
                        void **request) {
  MPI_Datatype origin_datatype_ = origin_datatype;
  ...
  MPI_Win win_ = win;
  MPI_Request *request_ = request;
  int ret = MPI_Rget_accumulate(origin_addr, origin_count, origin_datatype_,
                                result_addr, result_count, result_datatype_,
                                target_rank, target_disp_, target_count,
                                target_datatype_, op_, win_, request_);
  origin_datatype = origin_datatype_;
...
int mpi_Rput(const void *origin_addr, int origin_count,
  ...
  MPI_Request *request_ = request;
  int ret =
      MPI_Rput(origin_addr, origin_count, origin_datatype_, target_rank,
               target_disp_, target_count, target_datatype_, win_, request_);
  origin_datatype = origin_datatype_;
  target_disp = target_disp_;
  target_datatype = target_datatype_;
...
int mpi_Rsend(const void *buf, int count, void *datatype, int dest, int tag,
              void *comm) {
  MPI_Datatype datatype_ = datatype;
  MPI_Comm comm_ = comm;
...
int mpi_File_set_view(void *fh, void *disp, void *etype, void *filetype,
                      char *datarep, void *info) {
  MPI_File fh_ = fh;
  MPI_Offset disp_ = disp;
  MPI_Datatype etype_ = etype;
  MPI_Datatype filetype_ = filetype;
...
int mpi_Rsend_init(const void *buf, int count, void *datatype, int dest,
                   int tag, void *comm, void **request) {
  MPI_Datatype datatype_ = datatype;
  MPI_Comm comm_ = comm;
  MPI_Request *request_ = request;
...
int mpi_Scan(const void *sendbuf, void *recvbuf, int count, void *datatype,
             void *op, void *comm) {
  MPI_Datatype datatype_ = datatype;
  MPI_Op op_ = op;
  MPI_Comm comm_ = comm;
...
int mpi_Scatter(const void *sendbuf, int sendcount, void *sendtype,
                void *recvbuf, int recvcount, void *recvtype, int root,
                void *comm) {
  MPI_Datatype sendtype_ = sendtype;
  MPI_Datatype recvtype_ = recvtype;
  MPI_Comm comm_ = comm;
  int ret = MPI_Scatter(sendbuf, sendcount, sendtype_, recvbuf, recvcount,
                        recvtype_, root, comm_);
  sendtype = sendtype_;
  recvtype = recvtype_;
  comm = comm_;
